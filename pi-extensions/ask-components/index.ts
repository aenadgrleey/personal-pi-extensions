      ...
      items: {
        ...
        properties: {
          ...
          options: {
            type: "array",
            description:
              "Choices. A free-text option is appended automatically unless allowOther is false.",
            items: {
              type: "object",
              properties: {
                label: {
                ...
                description: {
                  type: "string",
                  description: "One-line hint shown below the label",
                },
              },
              required: ["label"],
          ...
          defaultIndex: {
            type: "number",
            description: "0-based index of the pre-selected option",
          },
          allowOther: {
            type: "boolean",
            description: "Show free-text option (default: true)",
          },
        },
...
export const askTool = {
  ...
  renderResult(
    ...
    if (details.cancelled) {
      ...
      if (answered > 0) {
        return new Text(
          theme.fg("warning", `✗ Cancelled (${answered} answered)`),
          0,
          0,
        );
      }
