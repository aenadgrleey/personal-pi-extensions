...
assert.deepEqual(buildSelfUpdateCommand("npm", "0.74.0"), {
	command: "npm",
	args: ["install", "-g", "@mariozechner/pi-coding-agent@0.74.0"],
	display: "npm install -g @mariozechner/pi-coding-agent@0.74.0",
});

assert.deepEqual(buildSelfUpdateCommand("bun", "0.74.0"), {
	command: "bun",
	args: ["install", "-g", "@mariozechner/pi-coding-agent@0.74.0"],
	display: "bun install -g @mariozechner/pi-coding-agent@0.74.0",
});
