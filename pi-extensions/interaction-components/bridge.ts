...
export interface InteractionBridge {
	presentAsk(ctx: ExtensionContext, questions: BridgeAskQuestion[]): Promise<BridgeAskResult>;
	presentPlanDecision(
...
export function setInteractionBridge(bridge: InteractionBridge | undefined): void {
